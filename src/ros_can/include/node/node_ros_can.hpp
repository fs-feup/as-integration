...
class RosCan : public rclcpp::Node {
 private:
  ...
  rclcpp::Publisher<custom_interfaces::msg::SteeringAngle>::SharedPtr bosch_steering_angle_publisher_;
  ...
  */
  void boschSteeringAngleSetOrigin();
